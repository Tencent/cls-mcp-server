...
export const noRegionProvidedErrorMessage =
...
export const msTimestampFromDesc =
...
export const msTimestampToDesc =
...
export const defaultTimeZone = process.env.TZ || systemTimeZone || TIMEZONE_SHANGHAI;
